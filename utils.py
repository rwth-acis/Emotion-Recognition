...
def get_best_estimators(classification):
    ...
    if classification:
        try: 
            print(os.getcwd())
            return pickle.load(open(r"./grid/best_classifiers.pickle", "rb"))
        except: 
            print("Some problem with the file location which is:" + os.getcwd())    
    else:
        return pickle.load(open(r"./grid/best_regressors.pickle", "rb"))
